%%
excelname='./heg1_myl9a_info.xlsx';
T = readtable(excelname,'Sheet','heg1-RE');


%%
folderName='./20230113heg1m552-cdh5-TS-myl9a-GFP/';
fileName='SUM_R3C4.lif - Series014.png';
PixelReso=0.286;
...
writetable(T,excelname,'Sheet','heg1-RE');
